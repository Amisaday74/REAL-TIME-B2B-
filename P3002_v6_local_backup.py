...
def EEG(second, folder, eno1_datach1, eno1_datach2):
    ...
    try:
        while (True):
            ...
            eno1_datach1[:1000] = lista1[:1000]
            eno1_datach2[:1000] = lista2[:1000]
...
def EEG2(second, folder, eno2_datach1, eno2_datach2):
    ...
    try:
        ...
        while (True):
            ...
            eno2_datach1[:1000] = lista12[:1000]
            eno2_datach2[:1000] = lista22[:1000]
...
if __name__ == '__main__':
    ...
    mgr = Manager()
    #ns = mgr.list()
    eno1_datach1 = multiprocessing.Array('d', 1000)
    eno1_datach2 = multiprocessing.Array('d', 1000)


    eno2_datach1 = multiprocessing.Array('d', 1000)
    eno2_datach2 = multiprocessing.Array('d', 1000)
